...
class LlmCallLoggerTest {
    ...
    void shouldWriteStructuredSuccessAndFailureFields() {
        ...
        try {
            ...
            llmCallLogger.logSuccess(context, new LlmCallMetrics(842, 231, 112, 343), "stop", false);
            ...
            assertTrue(logs.contains("LLM_CALL_SUCCESS stage=CAPABILITY_SUMMARY model=qwen3.5-plus traceId=trace-1 requestId=req-1 latencyMs=842 promptTokens=231 completionTokens=112 totalTokens=343 finishReason=stop truncated=false"));
